...
mouse doesn't move and the cats travel at equal speed. If the cats arrive at the same time, 
...
cats A and B , and for mouse C. Complete the function catAndMouse to return the appropriate answer to each 
...
Complete the catAndMouse function in the editor below. It should return one of the three 
